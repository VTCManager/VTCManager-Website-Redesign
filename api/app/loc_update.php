...
$coordinate_x = (double)$conn->real_escape_string($coordinate_x);
$coordinate_y = (double)$conn->real_escape_string($coordinate_y);
$rotation = (double)$conn->real_escape_string($rotation);
