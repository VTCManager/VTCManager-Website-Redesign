...
$sql = "INSERT INTO tour_table (username, departure, destination, truck_manufacturer, truck_model, cargo_weight, cargo, tour_id, status, companyID, depature_company, destination_company, distance)
