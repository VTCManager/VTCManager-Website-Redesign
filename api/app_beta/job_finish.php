...
$sql = "UPDATE tour_table SET status='finished', trailer_damage=$trailer_damage, money_earned=$income, fuelconsumption=$fuelconsumption WHERE username='$found_user' AND tour_id=$job_id";
