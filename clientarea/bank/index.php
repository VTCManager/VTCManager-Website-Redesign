...
<body class="elegant-color-dark">
  ...
  <p><strong>&nbsp;Transaktion erfolgreich!</strong></p>
                    ...
                    <div class="modal fade" id="transactioncompany" tabindex="-1" role="dialog">
                        <div class="modal-dialog elegant-color white-text" role="document">
                            <div class="modal-content elegant-color white-text">
                                <form action="transaction_user" method="post" name="transactForm" id="transact_form">
                                    <div class="modal-header">
                                        <h4 class="modal-title" id="myModalLabel">Überweisung von meinem Privatkonto tätigen</h4>
                    ...
                    <table class="table white-text" style="max-height: 150px !important; overflow: auto !important;">
                        ...
                        <tbody>
                            <?php
                            $sql = "SELECT * FROM money_transfer WHERE sender='$username_cookie' OR receiver='$username_cookie' ORDER by date_sent DESC LIMIT $start_from, " . $results_per_page;
                            $result = $conn->query($sql);
