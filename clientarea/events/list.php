            ...
            if (this.readyState == 4 && this.status == 200) {
                ...
                if (myObj != "") {
                    ...
                    for (var a in myObj["response"]) {
                        ...
                        if (myObj["response"][a]["severity"] == 'Heavy' || myObj["response"][a][
                            "severity"] == 'Congested') {
                            para.innerHTML = myObj["response"][a]["name"] +
                                ' <span class="badge badge-danger badge-pill pull-right">' + myObj[
                                    "response"][a]["players"] + '</span>';
                        } else if (myObj["response"][a]["severity"] == 'Moderate') {
                            para.innerHTML = myObj["response"][a]["name"] +
                                ' <span class="badge badge-warning badge-pill pull-right">' + myObj[
                                    "response"][a]["players"] + '</span>';
                        } else {
                            para.innerHTML = myObj["response"][a]["name"] +
                                ' <span class="badge badge-primary badge-pill pull-right">' + myObj[
                                    "response"][a]["players"] + '</span>';
                        }
                        para.className =
                            'list-group-item list-group-item-action waves-effect elegant-color white-text';
        ...
        xhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                ...
                if (myObj != "") {
                    ...
                    myNode.innerHTML = 'Verkehr Sim 1 [' + myObj["response"][0]["players"] + ' / ' + myObj[
                        "response"][0]["maxplayers"] + ']';
                } else {};
            }
        };
                    ...
                    <div class="modal-body mx-3 elegant-color white-text">
                        <div class="md-form mb-5">
                            <ul class="nav nav-tabs elegant-color white-text" id="myTab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="home-tab" data-toggle="tab" href="#webinterface"
                                        role="tab" aria-controls="WebInterface" aria-selected="true">WebInterface</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="home-tab" data-toggle="tab" href="#client" role="tab"
                                        aria-controls="Client" aria-selected="true">Client</a>
                                </li>
                            </ul>
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="webinterface" role="tabpanel"
                                    ...
                                    <p class="h2">aktuelle Version: 0.0.5 Alpha Build<p>
                                            ...
                                            <ul>
                                                ...
                                                <li>Angemeldete Benutzer können über HP direkt auf Interface zugreifen
                                                    ohne erneutes LogIn</li>
                                            </ul>
                                            ...
                                            <ul>
                                                <li>Daten werden nun aus der Benutzerfirma geladen und nicht aus der
                                                    Test-Firma</li>
                                            ...
                                            <ul>
                                                <li>Unterscheidung beim Onlinestatus zwischen VTConnect und
                                                    VTCMInterface</li>
            ...
            <div class="card mb-4 wow fadeIn">
                ...
                <div class="card-body d-sm-flex elegant-color white-text justify-content-between">
                    ...
                    <div class="d-flex justify-content-end">
                        <button type="button" class="btn btn-primary" data-toggle="modal" style="margin:.0rem;"
                            data-target="#viewchangelog">Changelog</button>
                    </div>
                </div>
