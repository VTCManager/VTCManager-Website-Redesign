...
<div class="loginFormWrapper">
	...
	echo '<form action="step3" method="post" name="registerform" id="account-register-form">';
}else{
		echo '<meter max="2" value="2"id="password-strength"style="opacity: 1; transform: matrix(1, 0, 0, 1, 0, 0);"></meter>';
	echo '<form action="finish" method="post" name="registerform" id="account-register-form">';
}?>
