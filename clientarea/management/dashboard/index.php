...
<body class="elegant-color-dark">
  ...
  <header>
    ...
    <!-- Sidebar -->
    <div class="modal fade" id="viewchangelog" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
          ...
          <div class="modal-body mx-3 elegant-color white-text">
            <div class="md-form mb-5">
              <ul class="nav nav-tabs elegant-color white-text" id="myTab" role="tablist">
                <li class="nav-item">
                  <a class="nav-link active" id="home-tab" data-toggle="tab" href="#webinterface" role="tab" aria-controls="WebInterface" aria-selected="true">WebInterface</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" id="home-tab" data-toggle="tab" href="#client" role="tab" aria-controls="Client" aria-selected="true">Client</a>
                </li>
              </ul>
              <?php include '../../../info/changelog.php'; ?>
            </div>
          </div>
        </div>
      </div>
