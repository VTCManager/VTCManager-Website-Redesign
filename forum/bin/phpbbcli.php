...
if( defined('APS') ) {
    // lock default ConsoleOutput (ob_start not catch fflush)
    class fakeOutput extends \Symfony\Component\Console\Output\ConsoleOutput
    {
    ...
    return $application->run($input, $fakeOut);
}
